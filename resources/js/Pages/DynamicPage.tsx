            ...
            <ErrorBoundary>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 animate-fade-in-up">
                    <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm border border-[#d4af37]/10 relative">
                        ...
                        <h1 className="text-3xl md:text-4xl font-luxury text-[#4a0e0e] mb-8 pb-4 border-b border-gray-100 text-center">
                            {page.title}
                        </h1>
                        
                        {/* Render HTML content safely */}
                        <div 
                            className="prose prose-sm sm:prose lg:prose-lg max-w-none prose-headings:font-luxury prose-h2:text-2xl prose-h3:text-xl prose-a:text-[#d4af37] hover:prose-a:text-[#4a0e0e] transition-colors prose-strong:text-[#4a0e0e]"
