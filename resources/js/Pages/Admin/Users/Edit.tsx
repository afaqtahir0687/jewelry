...
export default function AdminUsersEdit({ user, roles }: UsersEditProps) {
            ...
            <div className="max-w-2xl mx-auto">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mt-1">Update system user details</p>
                    </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="password" className="text-white">Password (leave blank to keep current)</Label>
                            <Input
                                id="password"
                                type="password"
                                value={data.password}
