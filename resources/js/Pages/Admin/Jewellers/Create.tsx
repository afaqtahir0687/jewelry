...
interface CreateJewellerProps {
    cities: City[];
    sellerUsers: User[];
}

export default function AdminJewellerCreate({ cities, sellerUsers }: CreateJewellerProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/jewellers');
    };

    return (
        <AdminLayout title="Add New Jeweller">
            <Head title="Create Jeweller — Admin" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="business_name"
                                    placeholder="e.g. Damascus Jewellers"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="full_address"
                                placeholder="Shop 4, Building 5A..."
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                            ...
                            <div className="flex items-center gap-2 mt-6">
                                ...
                                />
                                <Label htmlFor="is_verified" className="cursor-pointer">Verify Jeweller immediately</Label>
                            </div>
                        </div>
