...
interface CitiesEditProps {
    city: City;
}

export default function CitiesEdit({ city }: CitiesEditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(`/admin/cities/${city.id}`);
    };

    return (
        <AdminLayout title="Edit City">
            <Head title="Edit City — Admin" />
            ...
            <div className="mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Edit City: {city.name}</h2>
            </div>
