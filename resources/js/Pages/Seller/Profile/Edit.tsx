...
export default function SellerProfileEdit({ user }: ProfileEditProps) {
    ...
    return (
        <SellerLayout title="My Profile">
            <Head title="My Profile — Seller" />

            <div className="max-w-xl mx-auto">
                <div className="mb-6">
                    <h2 className="text-2xl font-bold text-white">Profile Information</h2>
                    <p className="text-gray-400 text-sm mt-1">Update your seller account's profile details and password.</p>
                </div>
