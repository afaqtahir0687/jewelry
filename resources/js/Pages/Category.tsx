    ...
    const filterFormFields = (
        <>
            ...
            <div className="pt-4 flex gap-2">
                ...
                <Link
                    href={`/${category.slug}`}
                    className="w-full text-center border border-[#5c1a1b]/20 hover:bg-[#fff8f0] text-[#5c1a1b] text-xs font-bold uppercase tracking-wider py-2.5 rounded transition-all duration-300 active:scale-[0.98]">
                    Clear
                </Link>
            </div>
        </>
        ...
        <AppLayout>
            ...
            <section className="bg-[#5c1a1b] text-white py-16 relative overflow-hidden border-b border-[#d4af37]/10">
                <div className="absolute inset-0 opacity-15">
                    ...
                    <div className="absolute inset-0 bg-[#5c1a1b]/80" />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="hidden lg:block lg:col-span-1">
                        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm space-y-6 transition-all duration-300 hover:shadow-md sticky top-24">
                            <h3 className="font-luxury text-base font-bold text-[#5c1a1b] border-b border-gray-100 pb-2">Filter Catalog</h3>
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <p className="text-sm text-gray-500">
                                Showing <span className="font-semibold text-[#5c1a1b]">{products.total}</span> design{products.total !== 1 ? 's' : ''}
                            </p>
                        </div>
                        ...
                        {products.data.length === 0 ? (
                            <div className="bg-white p-12 rounded-lg border border-gray-200 text-center shadow-sm">
                                ...
                                <h3 className="font-luxury font-bold text-xl mb-2 text-[#5c1a1b]">No Designs Found</h3>
