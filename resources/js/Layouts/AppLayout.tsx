...
export default function AppLayout({ children }: AppLayoutProps) {
    ...
    const { flash, seo_meta } = usePage<PageProps>().props;
    ...
    return (
        <div className="bg-[#faf9f6] font-sans text-[#0f172a] min-h-screen flex flex-col antialiased">
            ...
            <div className="bg-[#0f172a] text-[#d4af37] text-xs py-2 text-center tracking-widest uppercase font-semibold border-b border-[#d4af37]/20">
                <i className="fa-solid fa-gem mr-2"></i> Connecting You to Pakistan's Most Trusted Verified Artisans <i className="fa-solid fa-gem ml-2"></i>
            </div>
                    ...
                    <div className="flex justify-between h-20 items-center">
                        ...
                        <nav className="hidden md:flex space-x-6 lg:space-x-8 font-medium text-sm text-[#0f172a]/80">
                            ...
                            <div className="relative group flex items-center">
                                <button className="hover:text-[#d4af37] flex items-center gap-1.5 transition-colors duration-300 focus:outline-none cursor-pointer">
                                    Categories <i className="fa-solid fa-chevron-down text-[10px] transition-transform duration-300 group-hover:rotate-180"></i>
                                </button>
                                <div className="absolute top-full left-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible translate-y-3 group-hover:translate-y-0 bg-white/95 backdrop-blur-md border border-[#d4af37]/20 rounded-md shadow-xl py-2.5 w-52 transition-all duration-300 z-50">
                                    <Link href="/gold-jewellery" className="block px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#0f172a] hover:bg-[#faf9f6] hover:text-[#d4af37] hover:pl-6 transition-all duration-300">Gold Jewellery</Link>
                                    <Link href="/diamond-jewellery" className="block px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#0f172a] hover:bg-[#faf9f6] hover:text-[#d4af37] hover:pl-6 transition-all duration-300">Diamond Jewellery</Link>
                                    <Link href="/bridal-jewellery" className="block px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#0f172a] hover:bg-[#faf9f6] hover:text-[#d4af37] hover:pl-6 transition-all duration-300">Bridal Sets</Link>
                                    <Link href="/engagement-rings" className="block px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#0f172a] hover:bg-[#faf9f6] hover:text-[#d4af37] hover:pl-6 transition-all duration-300">Engagement Rings</Link>
                                </div>
                            </div>
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <a href="https://wa.me/923017730687" target="_blank" className="text-[#0f172a] hover:text-[#d4af37] text-lg px-2" title="WhatsApp">
                                <i className="fa-brands fa-whatsapp text-2xl text-green-500 hover:scale-110 transition-transform"></i>
                            </a>
                            <a href="tel:+923017730687" className="flex items-center gap-1.5 text-[#0f172a] hover:text-[#d4af37] transition-all duration-200 group" title="Call us">
                                <i className="fa-solid fa-phone text-lg group-hover:scale-110 transition-transform"></i>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-3 shadow-md animate-fade-in">
                        ...
                        <div className="border-t border-gray-100 my-2 pt-2">
                            ...
                            <Link href="/gold-jewellery" className="block pl-4 py-1 hover:text-[#d4af37]" onClick={() => setMobileMenuOpen(false)}>Gold Jewellery</Link>
                            <Link href="/diamond-jewellery" className="block pl-4 py-1 hover:text-[#d4af37]" onClick={() => setMobileMenuOpen(false)}>Diamond Jewellery</Link>
                            <Link href="/bridal-jewellery" className="block pl-4 py-1 hover:text-[#d4af37]" onClick={() => setMobileMenuOpen(false)}>Bridal Sets</Link>
                            <Link href="/engagement-rings" className="block pl-4 py-1 hover:text-[#d4af37]" onClick={() => setMobileMenuOpen(false)}>Engagement Rings</Link>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <div className="flex space-x-4">
                                <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#d4af37] hover:text-[#0f172a] flex items-center justify-center transition-all"><i className="fa-brands fa-facebook-f"></i></a>
                                <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#d4af37] hover:text-[#0f172a] flex items-center justify-center transition-all"><i className="fa-brands fa-instagram"></i></a>
                                <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#d4af37] hover:text-[#0f172a] flex items-center justify-center transition-all"><i className="fa-brands fa-tiktok"></i></a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li><Link href="/gold-jewellery" className="hover:text-[#d4af37] transition-colors">Gold Jewellery</Link></li>
                                <li><Link href="/diamond-jewellery" className="hover:text-[#d4af37] transition-colors">Diamond Jewellery</Link></li>
                                <li><Link href="/bridal-jewellery" className="hover:text-[#d4af37] transition-colors">Bridal Sets</Link></li>
                                <li><Link href="/engagement-rings" className="hover:text-[#d4af37] transition-colors">Engagement Rings</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="border-t border-white/10 pt-2 mt-2">
                                <span className="text-xs text-[#d4af37]"><i className="fa-solid fa-shield-halved mr-1"></i> 100% Verified Sellers Only</span>
                            </div>
                        </div>
