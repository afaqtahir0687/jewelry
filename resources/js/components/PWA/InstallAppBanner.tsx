  ...
  return (
    <>
      <div className="fixed bottom-24 md:bottom-6 right-4 left-4 md:left-auto md:w-96 bg-white border border-[#d4af37]/30 rounded-xl shadow-2xl p-4 z-40 flex items-start gap-3 animate-slide-up">
        ...
        <div className="w-12 h-12 rounded-lg bg-[#5c1a1b] flex items-center justify-center text-white shrink-0 border border-[#d4af37]/20 shadow-md">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex justify-between items-start">
            <h4 className="font-serif font-bold text-sm text-[#5c1a1b] leading-tight">Gehna Jewellery App</h4>
            <button 
              onClick={dismissBanner}
              className="text-gray-400 hover:text-[#5c1a1b] p-0.5"
          ...
          <button
            ...
            className="mt-3 px-4 py-1.5 bg-[#5c1a1b] hover:bg-[#7a2426] text-white text-xs font-semibold rounded-md transition-colors"
          >
            Install App
          </button>
        </div>
