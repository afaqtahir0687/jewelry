...
export default function IOSInstallInstructions({ isOpen, onClose }: IOSInstallInstructionsProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/60 backdrop-blur-sm animate-fade-in" onClick={onClose}>
      <div 
        className="w-full max-w-md bg-[#fff8f0] rounded-t-2xl border-t border-[#d4af37]/30 shadow-2xl px-6 pt-5 pb-8 relative text-[#4a0e0e] animate-slide-up"
      ...
      >
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <button 
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-[#4a0e0e]/5 hover:bg-[#4a0e0e]/10 flex items-center justify-center text-[#4a0e0e] transition-colors"
            aria-label="Close"
          >
        ...
        <div className="space-y-4 my-5 text-sm">
          <div className="flex items-center gap-3.5 bg-white/50 p-3 rounded-lg border border-[#d4af37]/10">
            <span className="w-7 h-7 rounded-full bg-[#4a0e0e] text-white flex items-center justify-center font-bold text-xs">1</span>
          ...
          <div className="flex items-center gap-3.5 bg-white/50 p-3 rounded-lg border border-[#d4af37]/10">
            <span className="w-7 h-7 rounded-full bg-[#4a0e0e] text-white flex items-center justify-center font-bold text-xs">2</span>
            <p className="flex-1 leading-relaxed">
          ...
          <div className="flex items-center gap-3.5 bg-white/50 p-3 rounded-lg border border-[#d4af37]/10">
            <span className="w-7 h-7 rounded-full bg-[#4a0e0e] text-white flex items-center justify-center font-bold text-xs">3</span>
            <p className="flex-1 leading-relaxed">
        ...
        <button 
          onClick={onClose}
          className="w-full py-3 bg-[#4a0e0e] hover:bg-[#b76e79] text-white rounded-lg font-semibold tracking-wide transition-colors shadow-lg shadow-[#4a0e0e]/10"
        >
          Got It
        </button>
      </div>
